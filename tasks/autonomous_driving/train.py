...
def _torch_load_with_full_checkpoint_default(*args, **kwargs):
    # MMEngine resume checkpoints store optimizer/history state, not only tensors.
    kwargs.setdefault('weights_only', False)
    return _orig_torch_load(*args, **kwargs)


torch.load = _torch_load_with_full_checkpoint_default
