...
# VPF parameters
_C.MODEL.VPF = CN()
_C.MODEL.VPF.PATCH_SIZE = 4
_C.MODEL.VPF.IN_CHANS = 3
_C.MODEL.VPF.EMBED_DIM = 96
_C.MODEL.VPF.DEPTHS = [2, 2, 9, 2]
_C.MODEL.VPF.MLP_RATIO = 4.
_C.MODEL.VPF.PATCH_NORM = True
_C.MODEL.VPF.POST_NORM = False #True
_C.MODEL.VPF.LAYER_SCALE = None
_C.MODEL.VPF.ABLATION = 'full'
