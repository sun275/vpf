...
from models import build_model,vpf
...
from utils.utils_ema import load_checkpoint_ema, load_pretrained_ema, save_checkpoint_ema,load_checkpoint_val
...
def main(config):
    ...
    if config.MODEL.RESUME:
        model_without_ddp = load_checkpoint_val(config, model_without_ddp, logger)
